...
* **[Scene Configuration](./modding-scene-tutorial-nyc.md)**: Build environments and configure scene prefabs.
* **[Character Configuration](./modding-character-tutorial-character.md)**: Create characters and hook up behavior where needed.
* **[Item Tutorials](./modding-item-tutorial-katana.md)**: See complete examples of TypeScript-driven weapons and tools.
